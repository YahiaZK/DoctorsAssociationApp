...
class DoctorsBadgeScreen extends ConsumerWidget {
  const DoctorsBadgeScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: Text(
          AppLocalizations.of(context)!.requestBadge,
          style: TextStyle(
            color: Colors.white,
            fontSize: 24,
              ...
              children: [
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          AppLocalizations.of(context)!.badgePreview,
                ...
                CustomContainer(
                  child: Column(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)!.doctorsBadgeTitle,
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
